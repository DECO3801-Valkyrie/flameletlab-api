...
public class NewsFeedService {
    ...
    private void performSearch(String searchTerm, NewsApiClient.ArticlesResponseCallback callback) {
    ...
    public List<Article> getArticles(User user) {
        ...
        for (Map.Entry<String, String> pair : tagPairs.entrySet()) {
            String searchTerm = occType.getName() + " " + pair.getKey() + " " + pair.getValue();
            performSearch(searchTerm, callback);
        }
